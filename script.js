    ...
    "id": {
        ...
        texts: {
            "page-title": "Selamat datang di herta kuru~",
             "doc-title": "Kuru Kuru~",
             "page-descriptions": "Situs web untuk Herta, karakter Honkai: Star Rail <del>menyebalkan</del> yang paling lucu dan jenius di luar sana.",
             // TODO dynamic texts for Indonesian
             "counter-descriptions": ["Kuru~ telah dipadatkan untuk", "Herta telah dikuru~untuk"],
             "counter-unit": "kali",
             "counter-button": ["Hancurkan kuru~!", "Kuru kuru~!"],
             "credits-gif": "Gif ini dibuat oleh",
             "footer-repository-text": "Repo GitHub",
             "access-via-pages": "Saat ini Anda mengakses melalui Halaman GitHub. Untuk pengguna di Tiongkok (Daratan) atau beberapa wilayah lainnya, klik <a href='https://herta.ft2.ltd/'>di sini untuk mengakses cermin di Netlify</a>.",
             "access-via-mirror": "Selamat! Anda menggunakan situs mirror, yang akan mempercepat akses di China (Daratan) dan beberapa wilayah. Klik di sini untuk <a href='https://duiqt.github.io/ herta_kuru/'>kunjungi situs sumber di Halaman GitHub</a>.",
             "footer-show-credits-text": "Show Credits"
        },
        cardImage: "img/card_en.jpg"
    }
